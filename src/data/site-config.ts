export const siteConfig = {
  ...
  email: "mdawoud@ucsc.edu",
  location: {
    building: "Engineering 2 (E2), Room E2-311",
    address: "1156 High Street",
    city: "Santa Cruz, CA 95064",
  },
  phone: "+1 (831) 900-8034",
  social: {
    email: "mdawoud@ucsc.edu",
  ...
  advisor: {
    name: "Prof. Ramakrishnan (Ram) Sundara Raman",
    url: "https://ramakrishnansr.com",
  },
  researchInterests: [
